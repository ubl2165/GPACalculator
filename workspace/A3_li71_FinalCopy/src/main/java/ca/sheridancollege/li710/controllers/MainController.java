...
public class MainController {
	...
	/*
	 * @Bean("restTemplate") public RestTemplate restTemplate(){ RestTemplate
	 * restTemplate = new RestTemplate(); MappingJackson2HttpMessageConverter
	...
	public String searchCourse(@RequestParam String keyword, Model model, 
		...
		Course[] courses = restTemplate.getForObject("http://localhost:8080/api/course/search/{keyword}", 
				Course[].class, keyword);
...
//		System.out.println(courses);
	...
	public String loadIndexpage(HttpSession session, Model model, RestTemplate rest) {

		// Get all incomplete courses as a list
		List<Course> incompleteCourses = da.findAllCompletedCourses(false);
//		Course[] incompleteCourses = rest.getForObject("http://localhost:8080/api/course/incomplete", Course[].class);
